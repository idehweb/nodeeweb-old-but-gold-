...
function PostCard({onClick, item, method, t}) {
    ...
    let slug = item.slug;
    let cat_inLink = "";
    if (item.firstCategory && item.firstCategory.slug)
                ...
                <div className={"post-content-style"}>
                    <div className="ad-card-content">
                        ...
                        <div>
                            ...
                            <Theprice list={true} price={price} salePrice={salePrice} single={false}/>}
                            {item.type === "variable" &&
                            <Theprice list={true} price={price} salePrice={salePrice} combinations={item.combinations}
                                      type={item.type}
                                      single={false}/>}
