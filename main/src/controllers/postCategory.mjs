...
var self = ( {
    ...
    all: function (req, res, next) {
        if (req.query.f) {
            ...
            PostCategory.find(search, function (err, categorys) {
                // console.log('err', err);
                ...
                PostCategory.countDocuments({}, function (err, count) {
    ...
    allSXml: async function () {
        ...
        return new Promise(async function (resolve, reject) {
            ...
            await PostCategory.find(search, async function (err, categorys) {
                if (err || !categorys) {
                    return await ([]);
                }
    ...
    s: function (req, res, next) {
        ...
        PostCategory.find(search, function (err, categorys) {
            ...
            PostCategory.countDocuments({}, function (err, count) {
                ...
                if (req.params._id)
                    PostCategory.findById(req.params._id, function (err, mainCat) {
                        // console.log('here');
    ...
    sidebar: function (req, res, next) {
        ...
        PostCategory.find(search, function (err, categorys) {
            ...
            PostCategory.countDocuments({}, function (err, count) {
                ...
                if (req.params.catId)
                    PostCategory.findById(req.params.catId, function (err, mainCat) {
                        // console.log('here');
                        if (categorys && categorys.length >= 0) {
                            if (mainCat) {
                                mainCat.back = true;
    ...
    exparty: function (req, res, next) {
        ...
        //     }
        // ];
        // PostCategory.create(s, function (err, category) {
        //     if (err || !category) {
        //         res.json({
        //             err: err,
        //             success: false,
    ...
    create: function (req, res, next) {
      ...
      if(req.body.parent=="")
        ...
        PostCategory.create(req.body, function (err, category) {
            if (err || !category) {
                res.json({
                    err: err,
                    success: false,
    ...
    edit: function (req, res, next) {
        PostCategory.findByIdAndUpdate(req.params.id, req.body, function (err, category) {
            if (err || !category) {
                res.json({
                    success: false,
                    message: 'error!',
