...
export default function App() {
  ...
  const { Action,Attributes,Category,Configuration,PrivateConfiguration,Customer,MainDashboard,Media,Menu,Order,OrderCart,Post,Product,Settings,Sms,Transaction,User } = resources;
  return (
    <Admin
