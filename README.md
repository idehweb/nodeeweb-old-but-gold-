...
It's fast. many modules are built-in and ready to use, it is modular and easily you can join modules, you can export android and iOS applications too.
